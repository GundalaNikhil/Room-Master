...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="numroom" id="numroom" value="">
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="adult" id="adult" value="">
  </div>
...
{
alert("In name Your Character must be 1 to 20 Character");
document.frm.name.select();
return false;
}
