...

{
	...
	if(empty($checkin) || empty($checkout) || empty($name) || !isset($_POST['optionsRadios']) ) {
		...
		$result = mysqli_query("INSERT INTO booking(checkin,checkout,roomtypes,roomnum,adult,title,name,address,contact) VALUES('$checkin','$checkout','$roomtypes','$roomnum','$adult','$title','$name','$address','$contact')");
